#++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
#---基于Arch Linux Cisco Packettracer软件的打包构建程序;--
#--AUR地址:https://aur.archlinux.org/packages/packettracer/
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
...
source=(
    'http://archive.org/download/packet-tracer-731-amd-64/PacketTracer_731_amd64.deb'
	'packettracer.sh'
